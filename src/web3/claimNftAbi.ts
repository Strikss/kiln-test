export const CLAIM_NFT_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'expectedPricePerToken', type: 'uint256' },
      { internalType: 'address', name: 'actualCurrency', type: 'address' },
      { internalType: 'uint256', name: 'actualExpectedPricePerToken', type: 'uint256' },
    ],
